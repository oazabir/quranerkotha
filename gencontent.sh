...
wget -l 10 -E -U mozilla -r -nc --user-agent "Mozilla/5.0 (Linux; Android 4.0.4; Galaxy Nexus Build/IMM76B) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.133 Mobile Safari/535.19" --domains=quranerkotha.com --ignore-tags=link,script --exclude-directories=tag,category,amp,feed,author,pdf,wp-includes,wp-json --accept-regex ".*/$|(/)(/.*/)index.html$" https://quranerkotha.com/
